...
public class TheorieExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private Vector<String> m_eisen =TheorieModel.getEisen();
    private Vector<String> m_paden = TheorieModel.getPaden();
    private Vector<String> m_regels =TheorieModel.getRegels();
    private Vector<String> m_lichten = TheorieModel.getLichten();
    private Vector<String> m_borden =TheorieModel.getBorden();
