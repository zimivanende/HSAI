...
public class LoginActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sp.getBoolean("isLoggedIn", false) || sp.getBoolean("isGuest", false)) {
        ...
        m_userIdView = (EditText) findViewById(R.id.userId);
        ...
        Button guestButton = (Button) findViewById(R.id.guest_login_button);
    ...
    private void attemptGuestLogin() {
        ...
        sp.edit().putBoolean("isGuest", true).apply();
        Intent transfer = new Intent(this, MainActivity.class);
        startActivity(transfer);
    }
    ...
    private void attemptLogin() {
        ...
        // Reset errors.
        m_userIdView.setError(null);
        m_passwordView.setError(null);

        // Store values at the time of the login attempt.
        String email = m_userIdView.getText().toString();
        ...
        if (TextUtils.isEmpty(email)) {
            m_userIdView.setError(getString(R.string.error_field_required));
            focusView = m_userIdView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            m_userIdView.setError(getString(R.string.error_invalid_email));
            focusView = m_userIdView;
            cancel = true;
        }
